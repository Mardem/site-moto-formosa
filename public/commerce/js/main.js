...
$(document).ready(function () {
	...
	$('.callback').fancybox({
	    ...
	    tpl: {
	        closeBtn: '<a title="Fechar" class="fancybox-item fancybox-close modal-form-close" href="javascript:;"></a>'
	    }
	});
	...
	$('.fancy-img').fancybox({
	    ...
	    tpl: {
	        closeBtn: '<a title="Fechar" class="fancybox-item fancybox-close modal-form-close2" href="javascript:;"></a>'
	    }
	});
	...
	if ($('#section-menu-btn').length > 0) {
		$('.section-top').on('click', '#section-menu-btn', function () {
			if ($(this).hasClass('opened')) {
				...
				$(this).addClass('opened').width($(this).width()).text('Fechar');
